...
def data_export_tab(database: dict[str, Any], scenario: dict[str, Any], source_name: str, database_fp: str) -> None:
    ...
    cols[5].download_button("Scenario Excel", _xlsx_bytes(scenario), "project_msr_active_scenario.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", use_container_width=True)
